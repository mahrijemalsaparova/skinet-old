...
export class ShopComponent implements OnInit {
  ...
  onBrandSelected(brandId: number) {
    ...
    // 2.sayfada eğer filterdaki seçeneğe basarsak error verir consolda. çünkü eğer 2.sayfada ise filter yaptığımız zaman
    // filterı 1.sayfadan itibaren göstermesi gerekir. bunu düzeltmek için:
